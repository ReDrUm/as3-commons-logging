package
{
	...
	public class ExampleClass extends Sprite
	{
		...
		public function ExampleClass()
		{
			...
			// The value for the Person field within Monster Debugger Traces Panel. Defaults to "".
			md3Params.person = "User";
			// The value for the Label field within Monster Debugger Traces Panel. Defaults to "".
			md3Params.label = "Label";
			// The text colour of the trace statement. Defaults to the colors defined within MonsterDebuggerV3Target (these can be overriden).
			md3Params.color = 0x0030AA;
			// The depth Monster Debugger should should display when tracing complex data types. Defaults to 5.
			md3Params.depth = 5;
			// Whether to use a class trace via MonsterDebugger.log() rather then MonsterDebugger.trace(). Defaults to false.
			md3Params.log = false;
